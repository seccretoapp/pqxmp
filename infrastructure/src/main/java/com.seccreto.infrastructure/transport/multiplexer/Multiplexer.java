...
public class Multiplexer implements MultiplexerInterface {
    ...
    public Multiplexer(ServerSocket serverSocket) {
    ...
    @Override
    public MultiplexerListener matchWithWriters(MatcherInterface... matchers) {
